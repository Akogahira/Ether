    ...
    <div>
      <ContainerMain>
        ...
        <ContainerHerrFiltro>
          ...
          <BotonConv onClick={() => handleFiltroChange('oficiales')}>Oficiales</BotonConv>
          <BotonConv onClick={() => handleFiltroChange('comunidad')}>Comunidad</BotonConv>
        </ContainerHerrFiltro>
        <ContainerHerr>
          <CardHerr style={{ display: filtro === 'todas' || filtro === 'oficiales' ? 'block' : 'none' }}>
          ...
          <CardHerr style={{ display: filtro === 'todas' || (filtro === 'oficiales' && filtro !== 'comunidad') ? 'block' : 'none' }}>
            <CardHerrInfo>
          ...
          <CardHerr style={{ display: filtro === 'todas' || (filtro === 'comunidad' && filtro !== 'oficiales') ? 'block' : 'none' }}>
            <CardHerrInfo>
